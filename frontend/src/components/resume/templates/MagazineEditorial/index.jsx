...
export default function MagazineEditorial() {
  ...
  const nodes = {
    // Editor's Note replaces the default summary block.
    ...
    experience: experience.length > 0 ? (
      <Section title="Selected Features" accent="#831843" uppercase={false}>
        {experience.map((e, i) => (
    ...
    skills: skills.length > 0 ? (
      <Section title="Capabilities" accent="#831843" uppercase={false}>
    ...
    education: education.length > 0 ? (
      <Section title="Education" accent="#831843" uppercase={false}>
        {education.map((e, i) => (
    ...
    projects: projects.length > 0 ? (
      <Section title="Portfolio" accent="#831843" uppercase={false}>
        {projects.map((p, i) => (
          <div key={i} style={{ marginBottom: '3mm' }}>
    ...
    certifications: certifications.length > 0 ? (
      <Section title="Credentials" accent="#831843" uppercase={false}>
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '8mm 22mm 12mm' }}>
        ...
        <OrderedSections
          nodes={nodes}
          sectionProps={{ accent: '#831843', uppercase: false }}
