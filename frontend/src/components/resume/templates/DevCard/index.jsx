...
export default function DevCard() {
  ...
  const nodes = {
    summary: personal.summary ? (
      <Section title="Bio" accent="#047857" uppercase={false}>
        <p style={{ margin: 0, color: '#334155' }}>{personal.summary}</p>
      </Section>
    ) : null,

    skills: skills.length > 0 ? (
      <Section title="Tech I work with" accent="#047857" uppercase={false}>
    ...
    experience: experience.length > 0 ? (
      <Section title="Where I've worked" accent="#047857" uppercase={false}>
        {experience.map((e, i) => (
          <ExperienceRow
            key={i}
            exp={e}
    ...
    projects: projects.length > 0 ? (
      <Section title="Pinned Repositories" accent="#047857" uppercase={false}>
        {projects.map((p, i) => (
          <article
            key={i}
            style={{
    ...
    certifications: certifications.length > 0 ? (
      <Section title="Verified Badges" accent="#047857" uppercase={false}>
