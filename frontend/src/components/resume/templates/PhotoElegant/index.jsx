...
export default function PhotoElegant() {
  ...
  const nodes = {
    ...
    education: education.length > 0 ? (
      <Section title="Education" accent="#0f766e" uppercase={false}>
        {education.map((e, i) => (
    ...
    skills: skills.length > 0 ? (
      <Section title="Skills" accent="#0f766e" uppercase={false}>
    ...
    certifications: certifications.length > 0 ? (
      <Section title="Certifications" accent="#0f766e" uppercase={false}>
